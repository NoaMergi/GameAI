...
enum EventType
{
	...
	ADD_DINAMIC_ARRIVE, ADD_DINAMIC_SEEK, DELETE_UNIT, QUIT_GAME, MOVE_PLAYER, DEBUG, INCREASE_SELECTED_VALUE, REDUCE_SELECTED_VAULUE, SELECT_VELOCITY, SELECT_REACTION_RAD, 
